...
class disjoint_set {
    disjoint_set(unordered_map<string, unordered_map<string, double>> nodesMap);
    unordered_map<string, string> parents;
    unordered_map<string, int> descendants;
...
class Graph {
    public:
        // Key: node label  Val: map of neighbors to distances 
        unordered_map<string, unordered_map<string, double>> nodesMap;  
